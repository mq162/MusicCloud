...
class ScalingCarouselCollectionView: UICollectionView {
...
private typealias PrivateAPI = ScalingCarouselCollectionView
 ...
 */
private typealias InvisibleScrollDelegate = ScalingCarouselCollectionView
extension InvisibleScrollDelegate: UIScrollViewDelegate {
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        */
        ...
        for cell in visibleCells {
            if let infoCardCell = cell as? PlayingTrackCell {
