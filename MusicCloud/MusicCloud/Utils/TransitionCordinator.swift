...
//  MusicCloud
//
//  Created by Quang Pham on 29/11/2020.
//
...
class TransitionCoordinator: NSObject {
    ...
    private weak var tabBarViewController: TabbarVC!
    private weak var playerViewController: PlayerVC!
    ...
    init(tabBarViewController: TabbarVC, playerViewController: PlayerVC) {
